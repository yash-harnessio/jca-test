...
public class Build extends BaseModel {
    ...
    private Build(long number, long queueId, String url) {
        super();
        this.number = number;
    ...
    public Build(long number, String url) {
        this.number = number;
        this.url = url;
    }
    ...
    protected Build setNumber(long number) {
        this.number = number;
        return this;
    }

    protected Build setQueueId(long queueId) {
        this.queueId = queueId;
        return this;
    }
